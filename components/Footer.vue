  ...
  <footer class="bg-gray-900 text-white mt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-xl font-bold">Jobs</span>
          </div>
          <p class="text-gray-300 mb-4 max-w-md">
            Nền tảng tìm việc làm IT hàng đầu Việt Nam. Kết nối nhà tuyển dụng với ứng viên tài năng.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Việc làm</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Công ty</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Chính sách</a></li>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-300">
        <p>&copy; 2024 ITJobs. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>